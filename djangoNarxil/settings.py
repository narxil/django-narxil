"""
Django settings for djangoNarxil project.
...
SECRET_KEY = '@#k_y$#jl05eql=tf#ta*&m14w_!9pr#6v4#q7lz2@*m$s2+=!'
...
ROOT_URLCONF = 'djangoNarxil.urls'
...
WSGI_APPLICATION = 'djangoNarxil.wsgi.application'
